    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?=media()?>images/avatar.jpg" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Mike Trujillo</p>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Usuarios</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="<?=base_url()?>permisso"><i class="icon fa fa-circle-o"></i> Permisos</a></li>
          </ul>
        </li>
        <li><a class="app-menu__item" href="<?=base_url()?>clientes"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Clientes</span></a></li>
        ...
        <li><a class="app-menu__item" href="<?=base_url()?>logout"><i class="app-menu__icon fa fa-sign-ou"></i><span class="app-menu__label">Salir</span></a></li>
      </ul>
    </aside>